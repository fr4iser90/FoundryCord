...
class AuthenticationService:
    ...
    async def initialize(self):
        ...
        # If the key service failed to initialize or load/generate a key, jwt_secret will be None.
        # Services depending on this must handle the None case or fail gracefully.
        if not self.jwt_secret:
             logger.critical("CRITICAL: JWT secret key could not be loaded or generated by KeyManagementService. Authentication will likely fail.")
             # Raise an exception or return early if a JWT secret is absolutely required for the service to function.
             # For now, we'll let it proceed and potentially fail later when the key is used.
             # raise RuntimeError("Failed to obtain JWT secret key")
