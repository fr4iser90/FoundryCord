...
class GuildTemplateChannelEntity(Base):
    ...
    channel_type = Column(String(length=50), nullable=False) 
    ...
    dashboard_config_snapshot = Column(JSON, nullable=True)
    ...
    discord_channel_id = Column(String, nullable=True, index=True, unique=False)
