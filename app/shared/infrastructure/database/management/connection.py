from app.shared.infrastructure.database.models.config import initialize_engine, initialize_session, engine, AsyncSession
...
class DatabaseConnection:
    ...
    async def ensure_initialized(self):
        ...
        if self.engine is None:
            from app.shared.infrastructure.database.models.config import engine, initialize_engine
            if engine is None:
