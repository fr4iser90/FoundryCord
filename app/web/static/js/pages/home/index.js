...
async function updateSystemResources() {
    try {
        const response = await fetch('/api/v1/bot-public-info/system-resources');
...
async function updateRecentActivities() {
    try {
        const response = await fetch('/api/v1/bot-public-info/recent-activities');
...
async function updatePopularCommands() {
    try {
        const response = await fetch('/api/v1/bot-public-info/popular-commands');
