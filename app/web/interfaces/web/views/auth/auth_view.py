...
class AuthView:
    ...
    def _register_routes(self):
        ...
        self.router.get("/insufficient-permissions", response_class=HTMLResponse)(self.insufficient_permissions)
    ...
    async def insufficient_permissions(self, request: Request):
...
insufficient_permissions = auth_view.insufficient_permissions
