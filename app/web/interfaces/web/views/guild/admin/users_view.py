...
class GuildAdminUsersView(BaseView): # Renamed Class, inherits BaseView
    """View for guild admin user management"""
    ...
    def __init__(self):
        ...
        super().__init__(APIRouter(prefix="/guild/{guild_id}/admin/users", tags=["Guild Admin: Users"])) 
...
guild_admin_users_view = GuildAdminUsersView()
# Export the router from the instance
router = guild_admin_users_view.router 