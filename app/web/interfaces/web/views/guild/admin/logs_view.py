...
class GuildAdminLogsView(BaseView): # Renamed Class, inherits BaseView
    """View for guild admin logs management"""
    ...
    def __init__(self):
        ...
        super().__init__(APIRouter(prefix="/guild/{guild_id}/admin/logs", tags=["Guild Admin: Logs"])) 
        self._register_routes()

    def _register_routes(self):
        """Register all routes for guild admin logs management"""
...
guild_admin_logs_view = GuildAdminLogsView()
# Export the router from the instance
router = guild_admin_logs_view.router 