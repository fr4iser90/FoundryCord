...
# Remove import of deleted DashboardEntity
# from app.shared.infrastructure.models.dashboards.dashboard_entity import DashboardEntity
# TODO: Import correct models (ActiveDashboardEntity, DashboardConfigurationEntity) when refactoring
...
class DashboardBuilder:
    ...
    TODO: [REFACTORING] This entire class needs rework to use ActiveDashboardEntity and DashboardConfigurationEntity.
    The current implementation based on the deleted DashboardEntity is broken.
    """
    ...
    async def build_dashboard(self, active_dashboard: Any, configuration: Any, data: Dict[str, Any]) -> Dict[str, Any]:
        """Build a complete dashboard from a model and data.
        TODO: Refactor this method.
        """
        logger.warning("DashboardBuilder.build_dashboard needs refactoring. Returning dummy data.")
        # Placeholder implementation to avoid errors
        return {
            'embed': nextcord.Embed(title="Dashboard (Needs Refactor)", description="Builder logic needs update."),
            'view': nextcord.ui.View(timeout=None),
            'dashboard': None # Cannot return the old dashboard object
        }
        # try:
        #     # Create the embed
    ...
    async def build_embed(self, configuration: Any, data: Dict[str, Any]) -> nextcord.Embed:
        """Build a Discord embed from dashboard configuration.
        TODO: Refactor this method.
        """
        logger.warning("DashboardBuilder.build_embed needs refactoring. Returning dummy embed.")
        # Placeholder
        embed = nextcord.Embed(title="Embed (Needs Refactor)", description="Builder logic needs update.")
    ...
    async def build_view(self, configuration: Any, data: Dict[str, Any]) -> nextcord.ui.View:
        """Build a Discord view with interactive components.
        TODO: Refactor this method.
        """
        logger.warning("DashboardBuilder.build_view needs refactoring. Returning empty view.")
        # Placeholder
        view = nextcord.ui.View(timeout=None)
        return view
        # try:
