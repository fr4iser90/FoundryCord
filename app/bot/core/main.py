...
from modules.middleware.rate_limit_middleware import setup as setup_rate_limit_middleware  # Import der Rate Limit Middleware
...
setup_rate_limit_middleware(bot)
